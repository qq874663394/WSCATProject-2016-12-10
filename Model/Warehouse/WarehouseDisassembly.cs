...
{
	/// <summary>
	/// WarehouseDisassembly:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class WarehouseDisassembly
	{
		...
		private decimal? _disassemblycost;
		...
		/// 拆卸费用
		/// </summary>
		public decimal? disAssemblyCost
		{
			set{ _disassemblycost=value;}
			get{return _disassemblycost;}
		}
		/// <summary>
		/// 单据日期
		/// </summary>
