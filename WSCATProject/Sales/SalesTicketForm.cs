...
namespace WSCATProject.Sales
{
    public partial class SalesTicketForm : TestForm
    {
        ...
        private void InitDataGridView()
        {
            ...
            gr.Cells["gridColumntuihuoshu"].Value = 0;
            gr.Cells["gridColumntuihuoshu"].CellStyles.Default.Alignment = DevComponents.DotNetBar.SuperGrid.Style.Alignment.MiddleCenter;
            gr.Cells["gridColumntuihuoshu"].CellStyles.Default.Background.Color1 = Color.Orange;
        }
        ...
        private void InitClient()
        {
            if (_Click != 1)
            {
                ...
                resizablePanel1.Location = new Point(460, 160);
        ...
        private void comboBoxtype_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "销售发货":
                        superGridControl1.PrimaryGrid.Columns["gridColumndinggoushu"].Visible = true;
                        superGridControl1.PrimaryGrid.Columns["gridColumntuihuoshu"].Visible = true;
                        break;
                    case "销售退货":
                        superGridControl1.PrimaryGrid.Columns["gridColumndinggoushu"].Visible = false;
                        superGridControl1.PrimaryGrid.Columns["gridColumntuihuoshu"].Visible = false;
                        break;
                    case "委托退货":
                        break;
                    case "委托结算退货":
